...
const MERCHANT_ID = "M226GLT3NOE8O";
const SECRET_KEY = "c8c1ae3a-6f7b-44aa-a1ac-29d7c6213729";
// const CALLBACK_URL = "https://abhinandhan.com/";
const CALLBACK_URL = "";
...
class Transaction {
  async addPaymentPhone(req, res) {
    try {
      let { userId, username, Mobile, orderId, amount, transactionid, config, orderType, callBack, redirecturl } =
        req.body;
      ...
      const paymentDetails = {
        ...
        amount: amount * 100,
        // redirectUrl: `https://abhinandhan.com/payment-success?transactionId=${data._id}&userID=${userId}`,
        redirectUrl: `https://a.com/payment-success?transactionId=${data._id}&userID=${userId}`,
        redirectMode: "POST",
        callbackUrl: "http://localhost:8000/api/user/payment-callback",
        mobileNumber: Mobile,
        paymentInstrument: {
          type: "PAY_PAGE",
        },
